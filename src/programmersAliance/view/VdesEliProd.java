...
public class VdesEliProd extends JFrame {
    ...
    private void inicializarComponentes() {
        texto[0] = new JLabel("Ingrese el ID del producto a eliminar:");
        texto[0].setBounds(11,20,277,21);
        getContentPane().add(texto[0]);
        area[0] = new JTextArea();
        area[0].setBounds(240,17,170,27);
        getContentPane().add(area[0]);

        botones[0] = new JButton("Eliminar");
        botones[0].setBounds(90, 60, 100, 27);
        botones[0].addActionListener(evt -> Controller.PProductos(false, false,false,false,false,true,false,false));
        getContentPane().add(botones[0]);

        botones[2] = new JButton("Desactivar");
        botones[2].setBounds(250, 60, 100, 27);
        botones[2].addActionListener(evt -> Controller.PProductos(false, false,false,false,false,false,true,false));
        getContentPane().add(botones[2]);

        botones[1] = new JButton("Volver");
        botones[1].setBounds(180, 97, 80, 27);
        botones[1].addActionListener(evt -> Controller.PProductos(false, false,false,false,false,false,false,true));
